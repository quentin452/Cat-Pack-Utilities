...
50 scripts scanned · 14 script→script import edges · 82 script→data-artifact edges · 20 distinct packenv data artifacts.
...
flowchart LR
    ...
    class S_bundle_check,S_bundle_drift,S_bundle_regression_gate,S_changelog_from_bundles,S_changelog_from_git,S_make_minimal_instance,S_cf_upload,S_modrinth_upload,S_release,S_release_changeset,S_release_log,S_release_mods,S_release_pack,S__installdependencies,S_MainClass,S_arch_map,S_boot_crash_scan,S_boot_profiler,S_cascade_report,S_census,S_chunkgen_bench,S_config_sync,S_deploy_prism,S_dist_parity,S_gate,S_gen_legacy_hashes,S_gen_placeholder_logos,S_housekeep,S_matou_bench,S_matou_server_smoke,S_matoulib_arch,S_mixin_collision,S_mod_update_checker,S_pack_sync,S_pathfind_test,S_pathnav_test,S_perf_bench,S_pipeline_status,S_reserve_slugs,S_scan_repos,S_security_audit,S_server_bootstrap_parity,S_spark_find,S_spark_parse,S_spark_profile,S_triage_forks,S_update_local,S_uv_template,S_wiki_sync script;
    class S_packenv hub;
